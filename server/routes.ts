...
export async function registerRoutes(
  ...
  async function calculateEnhancedSignals() {
    ...
    try {
      ...
      // Sort by pre-spike score, with combo score as tiebreaker, then RVOL
      // Research: preSpikeScore captures all 4 orthogonal dimensions
      // ComboScore counts how many primary filters are met (0-4)
      ...
      signals.sort((a: any, b: any) => {
        ...
        return (b.volumeSpikeRatio ?? 0) - (a.volumeSpikeRatio ?? 0);
      });
